...
public class DepthTransformerAdeptor extends PagerAdapter {
    private boolean isMultiScr;

    public DepthTransformerAdeptor(boolean isMultiScr) {
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        LinearLayout linearLayout = (LinearLayout) LayoutInflater.from(container.getContext()).inflate(R.layout.layout_depth_adeptor_child, null);
